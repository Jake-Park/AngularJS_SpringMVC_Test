...
public class RetrieverBarkingService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/User/workspace/JAXWSEclipse/WebContent/WEB-INF/retriever.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RetrieverBarkingService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/User/workspace/JAXWSEclipse/WebContent/WEB-INF/retriever.wsdl");
        }
        WSDL_LOCATION = url;
    }
